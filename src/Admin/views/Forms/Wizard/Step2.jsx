                ...
                <Row>
                    <Col md={10} mdOffset={1}>
                        <FormGroup>
                            ...
                            <FormControl type="text" name="website" placeholder="ex: http://www.creative-tim.com" onChange={(event) => this.setState({ website: event.target.value })}/>
                ...
                <Row>
                    <Col md={5} mdOffset={1}>
                        <FormGroup>
                            ...
                            <FormControl type="text" name="framework" placeholder="ex: http://www.creative-tim.com"/>
                        </FormGroup>
                    </Col>
                    <Col md={5}>
                        <FormGroup>

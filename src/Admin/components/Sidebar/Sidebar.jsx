...
class Sidebar extends Component{
    constructor(props){
        ...
        this.state = {
            ...
            openManageClinic: (this.activeRoute("/manage-clinic") !== '' ? true:false),
        ...
        return (
            ...
            <div className="sidebar" data-color="black" data-image={image}>
                ...
                <div className="logo">
                	...
                	<a style={{fontSize:'13px'}} href="/dashboard" className="simple-text logo-normal">
                		DESAI BHANSALI &<br></br>ASSOCIATES LLP RCM
                	</a>
                </div>
                        ...
                        */}
                        {
                            dashRoutes.map((prop,key) => {
                                ...
                                if(prop.collapse){
                                    return (
                                        <li className={this.activeRoute(prop.path)} key={key} id={prop.name == 'Pages' ? 'update-pages' : 'add-pages'}>
